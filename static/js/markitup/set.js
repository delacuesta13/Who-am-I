...
var mySettings = {
	markupSet:  [
		...
		{name:'Paragraph', key:'', openWith:'[p]',  closeWith:'[/p]'  },
		{separator:'---------------' },
		...
		{separator:'---------------' },
		{name:'Center', key:'', openWith:'[center]', closeWith:'[/center]' },
		{separator:'---------------' },
		...
		{separator:'---------------' },
		{name:'Quote', key:'', openWith:'[quote=[![Author]!]]', closeWith:'[/quote]' },
		{name:'Code', key:'', openWith:'[code]', closeWith:'[/code]' },
		{separator:'---------------' },
		{name:'Link', key:'', openWith:'[url=[![Enter an Url:!:http\://]!]]', closeWith:'[/url]', placeHolder:'text to link' },
